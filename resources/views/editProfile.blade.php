                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" method="POST" action="/doRegister" enctype="multipart/form-data">
                            ...
                            <div class="form-group {{ $errors->has('address') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <textarea name="address" id="address" cols="10" rows="5" class="form-control" name="address">{{$user->address}}</textarea>
                            ...
                            <div class="form-group {{ $errors->has('birthday') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="birthday" type="text" class="form-control" name="birthday" placeholder="mm/dd/yyyy" value="{{ $user->birthday }}">
